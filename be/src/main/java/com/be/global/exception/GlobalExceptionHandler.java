    ...
    public ResponseEntity<Object> handleBusiness(BusinessException exception) {
        ...
        HttpStatus status = switch (code) {
            case DEPARTMENT_NOT_FOUND, JOB_POSITION_NOT_FOUND, MEMBER_NOT_FOUND,
                    ...
                    EXAM_ATTEMPT_NOT_FOUND, NOTIFICATION_NOT_FOUND -> HttpStatus.NOT_FOUND;
            case DUPLICATE_DEPARTMENT_CODE, DUPLICATE_JOB_POSITION_CODE,
                    ...
                    RESIGNED_MEMBER_ASSIGNMENT, ENROLLMENT_PROGRESS_NOT_EDITABLE,
                    DUPLICATE_EXAM, DUPLICATE_QUESTION_SORT_ORDER, DUPLICATE_CHOICE_SORT_ORDER,
                    EXAM_HISTORY_DELETE_CONFLICT, EXAM_CONFIGURATION_LOCKED, ENROLLMENT_EXAM_NOT_EDITABLE,
                    EXAM_ALREADY_PASSED, EXAM_ATTEMPTS_EXHAUSTED, EXAM_ATTEMPT_ALREADY_SUBMITTED,
                    EXAM_ATTEMPT_NOT_SUBMITTED -> HttpStatus.CONFLICT;
            case ENROLLMENT_PROGRESS_ACCESS_DENIED, EXAM_ACCESS_DENIED -> HttpStatus.FORBIDDEN;
            case SELF_PARENT_DEPARTMENT, DEPARTMENT_CYCLE, REQUIRED_EMPLOYEE_ROLE,
                    ...
                    INVALID_NEW_EMPLOYEE_DAYS, INVALID_PROGRESS_RATE, INVALID_EXAM_CONFIGURATION,
                    INVALID_QUESTION_CONFIGURATION, INVALID_QUESTION_ORDER, INVALID_CHOICE_ORDER,
                    EXAM_ORDER_LIMIT_EXCEEDED, INVALID_EXAM_ANSWER -> HttpStatus.BAD_REQUEST;
        };
