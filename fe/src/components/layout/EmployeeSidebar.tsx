...
export function EmployeeSidebar() {
  ...
  return <aside className="sidebar employee-sidebar">
    ...
    <nav aria-label="직원 메뉴"><p className="nav-caption">메뉴</p><ul><li><NavLink className={({ isActive }) => `nav-item${isActive ? ' active' : ''}`} to="/employee/learning"><Icon name="book" /><span>내 교육</span></NavLink></li></ul></nav>
