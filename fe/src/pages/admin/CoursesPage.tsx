...
export function CoursesPage() {
  ...
  return <div className="management-page">
    <PageHeader title="교육과정" description="교육과정을 생성하고 운영 상태를 관리합니다."><Link className="admin-button primary-button" to="/admin/courses/new">+ 교육과정 만들기</Link></PageHeader>
